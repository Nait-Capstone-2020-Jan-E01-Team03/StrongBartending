...
(
	...
	Notes varchar(255) null,
	Subtotal decimal not null,--Inserted based on Total Price of all EventDetails Lines. Staff Services should be * Staff Count * Hours
	GST decimal not null, --Calculated as Subtotal *.05 before inserting
	Gratuity decimal  not null, -- Calulated as Subtotal * .18 before inserting
	Total decimal not null, -- Calculated as Subtotal+GST+Gratuity before inserting
	...
	constraint FK_EvnetLeadKey foreign key(LeadKey) references Leads(LeadKey)
);
GO
